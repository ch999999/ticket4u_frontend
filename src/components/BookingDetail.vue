<template>
    <v-card variant="flat" class="bg-none" width="400" min-height="400">
        <v-card-title class="text-h4 text-left">Booking Detail</v-card-title>
        <v-card-subtitle class="text-h5 white-text text-left" opacity="1">Schedule</v-card-subtitle>
        <br>
        <v-card-subtitle class="text-h6 text-left">Movie Title</v-card-subtitle>
        <v-card-subtitle class="text-h5 white-text text-left" opacity="1">{{ title }}</v-card-subtitle>
        <br>
        <v-card-subtitle class="text-h6 text-left">Location</v-card-subtitle>
        <v-card-subtitle class="text-h5 white-text text-left" opacity="1">{{ location }}</v-card-subtitle>
        <br>
        <v-card-subtitle class="text-h6 text-left">Date</v-card-subtitle>
        <v-card-subtitle class="text-h5 white-text text-left" opacity="1">{{ date }}</v-card-subtitle>
        <br>
        <v-row>
            <v-col cols="8">
                <v-card-subtitle class="text-h6 text-left">Seats ({{ seatCount }})</v-card-subtitle>
        ...
        <br><br>
        <v-card-subtitle class="text-h5 text-left" opacity="1">Transaction Detail</v-card-subtitle>
